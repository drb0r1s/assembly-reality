...
export const Instructions = {
    ...
    MOV: instruction => Encoder.twoOperands(instruction, {
    ...
    MOVB: instruction => Encoder.twoOperands(instruction, {
    ...
    ADD: instruction => Encoder.twoOperands(instruction, {
    ...
    ADDB: instruction => Encoder.twoOperands(instruction, {
    ...
    SUB: instruction => Encoder.twoOperands(instruction, {
    ...
    SUBB: instruction => Encoder.twoOperands(instruction, {
    ...
    INC: instruction => Encoder.oneOperand(instruction, {
        "register": "21"
    }),

    // INCB operand: REG (half.register)
    INCB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "22"
    }),

    // DEC operand: REG (register)
    DEC: instruction => Encoder.oneOperand(instruction, {
        "register": "23"
    }),

    // DECB operand: REG (half.register)
    DECB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "24"
    }),

    // CMP operands: REG (register) || IND (memory.register) || DIR (memory.number.*) || IMD (number.*)
    CMP: instruction => Encoder.twoOperands(instruction, {
    ...
    CMPB: instruction => Encoder.twoOperands(instruction, {
    ...
    JMP: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "2D",
        "number.*": "2E"
    }),

    // JC operand: IND (memoy.register) || IMD (number.*)
    JC: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "2F",
        "number.*": "30"
    }),

    // JNC operand: IND (memoy.register) || IMD (number.*)
    JNC: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "31",
        "number.*": "32"
    }),

    // JZ operand: IND (memoy.register) || IMD (number.*)
    JZ: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "33",
        "number.*": "34"
    }),

    // JNZ operand: IND (memoy.register) || IMD (number.*)
    JNZ: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "35",
        "number.*": "36"
    }),

    // JA operand: IND (memoy.register) || IMD (number.*)
    JA: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "37",
        "number.*": "38"
    }),

    // JNA operand: IND (memoy.register) || IMD (number.*)
    JNA: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "39",
        "number.*": "3A"
    }),

    // PUSH operand: REG (register) || IMD (number.*)
    PUSH: instruction => Encoder.oneOperand(instruction, {
        "register": "3B",
        "number.*": "3C"
    }),

    // PUSHB operand: REG (half.register) || IMD (number.*)
    PUSHB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "3F",
        "number.*": "40"
    }),

    // POP operand: REG (register)
    POP: instruction => Encoder.oneOperand(instruction, {
        "register": "43"
    }),

    // POPB operand: REG (half.register)
    POPB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "44"
    }),

    // CALL operand: IND (memory.register) || IMD (number.*)
    CALL: instruction => Encoder.oneOperand(instruction, {
        "memory.register": "45",
        "number.*": "46"
    }),
    ...
    MUL: instruction => Encoder.oneOperand(instruction, {
        "register": "48",
        "memory.register": "49",
        "memory.number.*": "4A",
        "number.*": "4B"
    ...
    MULB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "4C",
        "memory.register": "4D",
    ...
    DIV: instruction => Encoder.oneOperand(instruction, {
        "register": "50",
        "memory.register": "51",
        "memory.number.*": "52",
        "number.*": "53"
    ...
    DIVB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "54",
        "memory.register": "55",
    ...
    AND: instruction => Encoder.twoOperands(instruction, {
    ...
    ANDB: instruction => Encoder.twoOperands(instruction, {
    ...
    OR: instruction => Encoder.twoOperands(instruction, {
    ...
    ORB: instruction => Encoder.twoOperands(instruction, {
    ...
    XOR: instruction => Encoder.twoOperands(instruction, {
    ...
    XORB: instruction => Encoder.twoOperands(instruction, {
    ...
    NOT: instruction => Encoder.oneOperand(instruction, {
        "register": "70"
    }),

    // NOTB operand: REG (half.register)
    NOTB: instruction => Encoder.oneOperand(instruction, {
        "half.register": "71"
    }),

    // SHL operands: REG (register) || IND (memory.register) || DIR (memory.number.*) || IMD (number.*)
    SHL: instruction => Encoder.twoOperands(instruction, {
    ...
    SHLB: instruction => Encoder.twoOperands(instruction, {
    ...
    SHR: instruction => Encoder.twoOperands(instruction, {
    ...
    SHRB: instruction => Encoder.twoOperands(instruction, {
    ...
    IN: instruction => Encoder.oneOperand(instruction, {
        "register": "87",
        "memory.register": "88",
        "memory.number.*": "89",
        "number.*": "8A"
    ...
    OUT: instruction => Encoder.oneOperand(instruction, {
        "register": "8B",
        "memory.register": "8C",
        "memory.number.*": "8D",
        "number.*": "8E"
