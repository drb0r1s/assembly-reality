...
export const registersString = [...registers].sort((a, b) => b.length - a.length).join("|");

export const registersRegex = new RegExp(`\\s(${registersString})(?=\\s|,|$)`);
export const memoryRegistersRegex = new RegExp(`\\s\\[(${registersString})\\](?=\\s|,|$)`);